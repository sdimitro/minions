...
int main() {
    // Vector size
    const int n = 1000000000; // 1 billion elements
    ...
    printf("3. GPU Benchmarks with Different Block Sizes\n");
    int blockSizes[] = {32, 64, 128, 131, 256, 300, 512, 1024};
    ...
    printf("6. GPU Device Information\n");
    cudaDeviceProp prop;
