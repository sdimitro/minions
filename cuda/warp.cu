...
int main() {
    ...
    for (int i = 0; i < numBlockSizes; i++) {
        ...
        // int gridSize = (n + blockSize - 1) / blockSize; // Not needed here, benchmarkGPU calculates it
        ...
        printf("    Block size: %3d, Time: %.4f s, Speedup: %5.1fx %s\n", 
               blockSize, gpu_time, cpu_time / gpu_time,
               isMultipleOf32 ? "✓" : "✗");
